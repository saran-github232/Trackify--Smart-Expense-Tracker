...
class AnalyticsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = ActivityAnalyticsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun bindAnalytics(data: AnalyticsData) {
        ...
        cats.entries.forEachIndexed { index, (cat, amount) ->
            val row = ItemCategoryStatBinding.inflate(layoutInflater, binding.llCategoryStats, false)
